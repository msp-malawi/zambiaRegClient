...
CREATE TABLE "REG"."TEMPLATE" ("ID" VARCHAR(36) NOT NULL, "NAME" VARCHAR(128) NOT NULL, "DESCR" VARCHAR(256), "FILE_FORMAT_CODE" VARCHAR(36) NOT NULL, "MODEL" VARCHAR(128), "FILE_TXT" VARCHAR(6086), "MODULE_ID" VARCHAR(36), "MODULE_NAME" VARCHAR(128), "TEMPLATE_TYP_CODE" VARCHAR(36) NOT NULL, "LANG_CODE" VARCHAR(3) NOT NULL, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."USER_BIOMETRIC" ("USR_ID" VARCHAR(36) NOT NULL, "BMTYP_CODE" VARCHAR(36) NOT NULL, "BMATT_CODE" VARCHAR(36) NOT NULL, "BIO_RAW_IMAGE" BLOB(2147483647), "BIO_ISO_IMAGE" BLOB(2147483647), "QUALITY_SCORE" NUMERIC(8,3), "NO_OF_RETRY" SMALLINT, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP, "BIO_MINUTIA" CLOB(2147483647));
...
CREATE TABLE "REG"."USER_TOKEN" ("USR_ID" VARCHAR(36) NOT NULL, "TOKEN" VARCHAR(4086), "TOKEN_EXPIRY" BIGINT, "REFRESH_TOKEN" VARCHAR(4086), "RTOKEN_EXPIRY" BIGINT, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP);
-- ----------------------------------------------
