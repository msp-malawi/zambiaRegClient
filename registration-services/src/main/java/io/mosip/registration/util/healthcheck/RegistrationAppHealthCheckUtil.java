...
public class RegistrationAppHealthCheckUtil {
	...
	public static String mosipHostNamePlaceHolder = "${qa.hostname}";
	...
	public static boolean isNetworkAvailable() {
		...
		try (InputStream keyStream = DaoConfig.class.getClassLoader().getResourceAsStream("spring.properties")) {
			...
			defaultHost = keys.getProperty("qa.hostname");
	...
	public static boolean checkServiceAvailability(String serviceUrl) {
		...
		try {
			...
			// serviceUrl = serviceUrl != null && System.getenv("qa.hostname") != null
			// ? serviceUrl.replace("${qa.hostname}", System.getenv("qa.hostname"))
			// : serviceUrl;
	...
	public static String getHostName() {
		String hostname = System.getenv("qa.hostname");
