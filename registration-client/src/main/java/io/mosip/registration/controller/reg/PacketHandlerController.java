...
public class PacketHandlerController extends BaseController implements Initializable {
	...
	public void showReciept() {
		...
		try {
			...
			System.out.println("ackTemplateText "+ackTemplateText);
...
//ackTemplateText="<html> <head> <meta http-equiv=Content-Type content=\"text/html; charset=UTF-8\"> <style type=\"text/css\"> .header { display :inline-block; left:150.30px; } #rightImage { margin-left : 350px; position:absolute; } </style> <script> document.onreadystatechange = function () {if(document.readyState === \"complete\"){var body = document.getElementsByTagName(\"body\")[0]; body.addEventListener(\"dragstart\", function(event) {event.preventDefault();}); body.addEventListener(\"selectstart\", function(event) {event.preventDefault();});}} </script> <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"/> </head> <body > <div style=\"position:absolute;left:40%;margin-left:-299px;top:0px;width:800px;height:600px;border-style:hidden;\"> <div style=\"bottom:30px;\"> <div> <div class =\"header\"> <img src=\"${LOGO1}\" style=\"position:absolute;left:35.30px;top:02.77px\" width=\"100\" height=\"100\"> </div> <div style=\"position:absolute;left:12.02px;top:165.34px\" class=\"cls_005\"><span class=\"cls_005\"> Registration Center:</span></div> <div style=\"position:absolute;left:199.67px;top:165.34px\" class=\"cls_005\"><span class=\"cls_005\">${RegCenter}</span></div> <div class =\"header\" style=\"position:absolute;left:270.30px;top:55.77px\" class=\"cls_002\"><span class=\"cls_002\">Republic of the Philippines</span></div> <div class =\"header\" style=\"position:absolute;left:215.90px;top:78.75px\" class=\"cls_003\"><span class=\"cls_003\">PHILIPPINE STATISTICS AUTHORITY</span></div> <div id=\"rightImage\" class =\"header\"><img class =\"header\" style=\"position:absolute;left:75.30px;top:02.77px\" src=\"${LOGO2}\" width=\"200\" height=\"100\" ></div> </div> <div style=\"position:absolute;left:242.71px;top:125.79px\" class=\"cls_004\"><span class=\"cls_004\">PHILSYS TRANSACTION SLIP</span></div> <div style=\"position:absolute;left:12.02px;top:185.34px\" class=\"cls_005\"><span class=\"cls_005\">Name:</span></div> <div style=\"position:absolute;left:199.67px;top:185.34px\" class=\"cls_005\"><span class=\"cls_005\"> #if($demographics.get(\"firstName\")) $demographics.get(\"firstName\").get(\"primaryValue\") #end #if($demographics.get(\"middleName\")) $demographics.get(\"middleName\").get(\"primaryValue\") #end #if($demographics.get(\"lastName\")) $demographics.get(\"lastName\").get(\"primaryValue\") #end #if($demographics.get(\"suffix\")) $demographics.get(\"suffix\").get(\"primaryValue\") #end</span></div> <div style=\"position:absolute;left:12.02px;top:205.74px\" class=\"cls_005\"><span class=\"cls_005\">Transaction Number:</span></div> <div style=\"position:absolute;left:199.67px;top:206.74px\" class=\"cls_005\"><span class=\"cls_005\">${RID}</span></div> <br> <div style=\"position:absolute;left:315.01px;top:245.67px\" class=\"cls_006\"> <img src=\"${QRCodeSource}\" style=\"top:50px\"; width=\"100\" height=\"100\"> </div> </div> <div style=\"position:absolute;left:2%;top:445.13px\" class=\"cls_007\"><span class=\"cls_007\"><b>INFORMATION:</b></span></div> <div style=\"position:absolute;left:2%;top:472.13px\" class=\"cls_007\">&#8226</div> <div style=\"position:absolute;left:4%;top:472.13px\" class=\"cls_007\"> Use this Transaction Slip to claim your PhilID card. For pick-up present this to the screener at the fixed registration center where you applied</div> <div style=\"position:absolute;left:2%;top:526.13px\" class=\"cls_007\">&#8226</div> <div style=\"position:absolute;left:4%;top:526.13px\" class=\"cls_007\"> For Delivery, present this to the courier upon delivery </div> <div style=\"position:absolute;left:2%;top:561.13px\" class=\"cls_007\">&#8226</div> <div style=\"position:absolute;left:4%;top:561.13px\" class=\"cls_007\"> This is elactronically generated slip.</div> </div> </div> </div> </body> </html>";
