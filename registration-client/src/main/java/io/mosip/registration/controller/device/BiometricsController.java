...
public class BiometricsController extends BaseController /* implements Initializable */ {
    ...
    @FXML
    private Label leftIrisScoreIdemia;

    @FXML
    private Label rightIrisScoreIdemia;

    @FXML
    private Label finger1Idemia;

    @FXML
    private Label finger2Idemia;

    @FXML
    private Label finger3Idemia;

    @FXML
    private Label finger4Idemia;
...
//        String thresholdScore = getValueFromApplicationContext(thresholdKey);
    ...
    private void clearBioLabels() {
        ...
        finger3.setText("");
        finger4.setText("");
//        leftIrisScoreIdemia.setText("");
//        rightIrisScoreIdemia.setText("");
//        finger1Idemia.setText("");
//        finger2Idemia.setText("");
//        finger3Idemia.setText("");
//        finger4Idemia.setText("");
...
//		captureTimeValue.setStyle("-fx-text-fill:#147f55");
        ...
        for (BiometricsDto biometricDTO : biometricDTOList) {
            ...
            if (biometricDTO.getBioAttribute().equalsIgnoreCase("leftEye")) {
                ...
                leftIrisScore.setStyle("-fx-font-size:9.0px");
//                leftIrisScoreIdemia.setText("BioSDK Score " + "- " + getQualityScore(biometricDTO.getIdemiaQualityScore()));
//                leftIrisScoreIdemia.setStyle("-fx-font-size:9.0px");
                changeLabelColor(leftIrisScore, biometricDTO);
            }
            if (biometricDTO.getBioAttribute().equalsIgnoreCase("rightEye")) {
                //rightIrisScoreIdemia.setText("BioSDK Score " + "- " + getQualityScore(biometricDTO.getIdemiaQualityScore()));
                rightIrisScore.setText("Right Eye " + "- " + getQualityScore(biometricDTO.getQualityScore()));
                rightIrisScore.setStyle("-fx-font-size:9.0px");
//                rightIrisScoreIdemia.setText("BioSDK Score " + "- " + getQualityScore(biometricDTO.getIdemiaQualityScore()));
//                rightIrisScoreIdemia.setStyle("-fx-font-size:9.0px");
                changeLabelColor(rightIrisScore, biometricDTO);
            }
            if (biometricDTO.getBioAttribute().equalsIgnoreCase("rightIndex")) {
                ...
                finger1.setStyle("-fx-font-size:9.0px");
//                finger1Idemia.setText("BioSDK Score " + "- " + getQualityScore(biometricDTO.getIdemiaQualityScore()));
//                finger1Idemia.setStyle("-fx-font-size:9.0px");
                changeLabelColor(finger1, biometricDTO);
            }
            if (biometricDTO.getBioAttribute().equalsIgnoreCase("rightMiddle")) {
                ...
                finger2.setStyle("-fx-font-size:9.0px");
//                finger2Idemia.setText("BioSDK Score " + "- " + getQualityScore(biometricDTO.getIdemiaQualityScore()));
//                finger2Idemia.setStyle("-fx-font-size:9.0px");
                changeLabelColor(finger2, biometricDTO);
            }
            if (biometricDTO.getBioAttribute().equalsIgnoreCase("rightRing")) {
                ...
                finger3.setStyle("-fx-font-size:9.0px");
//                finger3Idemia.setText("BioSDK Score " + "- " + getQualityScore(biometricDTO.getIdemiaQualityScore()));
//                finger3Idemia.setStyle("-fx-font-size:9.0px");
                changeLabelColor(finger3, biometricDTO);
            }
            if (biometricDTO.getBioAttribute().equalsIgnoreCase("rightLittle")) {
                ...
                finger4.setStyle("-fx-font-size:9.0px");
//                finger4Idemia.setText("BioSDK Score " + "- " + getQualityScore(biometricDTO.getIdemiaQualityScore()));
//                finger4Idemia.setStyle("-fx-font-size:9.0px");
                changeLabelColor(finger4, biometricDTO);
            }
...
//                finger2Idemia.setStyle("-fx-font-size:9.0px");
    ...
    private void changeLabelColorIdemia(Label label, Label label1, BiometricsDto biometricsDto) {
        ...
        if (gridPane.getId().equals(subType)) {
            ...
            for (Node node : gridPane.getChildren()) {
                ...
                if (node.getId().equalsIgnoreCase(modality)) {
                    ...
                    HBox hBox = (HBox) vBox.getChildren().get(0);
                    // hBox.getChildren().clear();
                    ((ImageView) (hBox.getChildren().get(0))).setImage(uiImage != null ? uiImage : new Image(this.getClass().getResourceAsStream(getImageIconPath(modality))));

                    ImageView imageViewUi = (ImageView) hBox.getChildren().get(0);
                    imageViewUi.setFitHeight(80);
                    imageViewUi.setFitWidth(93);
//                        imageViewUi.setFitWidth(hBox.getWidth());  // Stretch to HBox width
//                        imageViewUi.setFitHeight(hBox.getHeight()); // Optional: match height
//                        imageViewUi.setPreserveRatio(false);
//                        imageViewUi.setSmooth(true);
                    if (isCaptured) {
                        if (hBox.getChildren().size() == 1) {
                            ImageView imageView;
                            if (uiImage == null) {
                                imageView = new ImageView(new Image(this.getClass().getResourceAsStream(RegistrationConstants.EXCLAMATION_IMG_PATH)));
                            } else {
                                imageView = new ImageView(new Image(this.getClass().getResourceAsStream(RegistrationConstants.TICK_CIRICLE_IMG_PATH)));
                            }

                            // Make the status icon smaller and aligned better
                            imageView.setFitWidth(40); // Smaller size
                            imageView.setFitHeight(40);
//                                imageView.setPreserveRatio(true);
                            imageView.setSmooth(true);

                            // Optional: add margin to separate from the left icon
                            HBox.setMargin(imageView, new Insets(5, 0, 0, 8)); // top, right, bottom, left

                            hBox.getChildren().add(imageView);
                        } else {
                            // Remove and replace if already present
                            if (hBox.getChildren().size() > 1) {
                                hBox.getChildren().remove(1);
                            }
                        }
